...
%    \begin{adjustbox}{max width=\textwidth}
    ...
    \textbf{\makecell[r]{Hosting\\Syntax}} &
      ...
      Python &
      Python &
      \makecell{custom Java\\extension} &  % astra
      \makecell{custom Java\\extension} &  % jack
      \makecell{XML\\Java annotations} &  % jadex
      \makecell{custom Prolog\\extension}  % goal
      \\\hline
    ...
    \textbf{Interoperability} &
      \makecell[c]{native Java, Kotlin\\FFI native} &
      \makecell[c]{FFI Java} &
    ...
    \textbf{\makecell[r]{Reuse\\mechanisms}} &
      ...
      \makecell{file incl.,\\internal actions} &
      \makecell{Any Python\\mechanism} &
      \makecell{Any Python\\mechanism} &
      \makecell{agent\\extension} &
      \makecell{reusable plans \\and capabilities} &
      \makecell{selective file incl.\\Java inheritance} &
      \makecell{reusable plans,\\beliefs, goals,\\and agents}
      \\\hline
