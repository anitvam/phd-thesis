...
%
Some examples of such approaches include \mapek{}~\cite{kephart2003computer}, and \ac{PRS}~\cite{georgeff1987aaai}.
%
...
This paper proposes to investigate a novel cognitive agent-oriented framework that seamlessly integrates 
...
decision-making~\cite{Bratman1987-BRAIPA}. 
%
...
application-level network protocols~\cite{baiardi2025robust}, 
...
meant to improve \ac{BDI} ergonomics with pluggable concurrency and communication management constructs~\cite{baiardi2024sncs}.
...
which is a \ac{DES} engine for simulating large-scale distributed systems~\cite{alchemist}.
%
