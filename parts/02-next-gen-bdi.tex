...
companies would adopt agent technologies as a fundamental part of their infrastructure~\cite{mcburney2007expert},
...
\begin{enumerate}[label=\textbf{(G\arabic*)}]
    ...
    (from the \agentspeak{} semantic~\cite{DBLP:conf/maamaw/Rao96})
...
In the remainder of this chapter 
we will refer to \ac{BDI} agents implicitly assuming \agentspeak{(L)}-like agents.
...
and identify the integration requirements in \Cref{sec:gap-analysis}.
%
Next,
...
and we discuss the open challenges and opportunities of this approach.
