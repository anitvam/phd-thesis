...
%
Our analysis addresses the main questions surrounding this integration:
...
%
An example of the latter is the \ac{AP} paradigm~\cite{BealIEEEComputer2015}.
...
This paper bridges together cognitive \ac{BDI} \ac{AOP} and \ac{AP} paradigms, 
creating a unified framework that leverages the strengths of the both.
%
The integration of \ac{AP} paradigm and \ac{AOP} was first explored in~\cite{viroli2017ijaose}, 
...
%
Specifically, 
we leverage existing frameworks for both \ac{BDI} and \ac{AP} paradigm abstractions.
...
with \ac{AP} paradigm mechanisms for collective coordination.
%
...
are some examples of successful application of \ac{AP} paradigm.
% where the emergent behavior of the collective exceeds what individual agents could achieve independently.
%
\ac{AP} paradigm~\cite{BealIEEEComputer2015} is a functional macro-programming paradigm
...
\ac{jakta} for \ac{BDI} \ac{AOP} and Collektive for \ac{AP} paradigm.
%
...
Collektive\footnote{https://github.com/Collektive/collektive} is a prototype framework for \ac{AP} paradigm based on \ac{XC}~\cite{audrito2024jss},
which extends the Kotlin compiler plugin for performing \ac{AP} paradigm \emph{alignment}~\cite{audrito2016saso}.
%
...
%
In this paper, we propose such an integration, 
...
that well-behaved (typically, self-stabilising~\cite{dijkstra1974self})
...
The approaches discussed in \Cref{sec:background} 
