...
\begin{figure}
    \centering
    \caption{Generalized \ac{BDI} engine architecture. The generalized \ac{BDI} reasoning layer is agnostic to the knowledge representation technology used in the concrete specification layer, which can be tailored to support different formats (e.g., \ac{RDF}, JSON, YAML, etc.).}
